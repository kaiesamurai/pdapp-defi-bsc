  ...
  <div id="result"></div>
    ...
    <div className="mx-auto w-full max-w-screen-xl">
      <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
        <div>
            <h2 className="mb-6 text-sm font-semibold text-black-900 uppercase dark:text-red">Company</h2>
            <ul className="text-black-500 dark:text-black-400 font-medium">
                <li className="mb-4">
                    <a href="#" className=" hover:underline text-black-500 dark:text-red-400 font-medium">About</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="hover:underline text-black-500 dark:text-red-400 font-medium">Careers</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="hover:underline text-black-500 dark:text-red-400 font-medium">Brand Center</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="hover:underline text-black-500 dark:text-red-400 font-medium">Blog</a>
                </li>
            </ul>
        </div>
        <div>
            <h2 className="mb-6 text-sm font-semibold text-black-900 uppercase dark:text-red">Help center</h2>
            <ul className="text-black-500 dark:text-black-400 font-medium">
                <li className="mb-4">
                    <a href="#" className=" hover:underline text-black-500 dark:text-red-400 font-medium">Discord Server</a>
                </li>
                <li className="mb-4">
                    <a href="#" className=" hover:underline text-black-500 dark:text-red-400 font-medium">Twitter</a>
                </li>
                <li className="mb-4">
                    <a href="#" className=" hover:underline text-black-500 dark:text-red-400 font-medium">Facebook</a>
                </li>
                <li className="mb-4">
                    <a href="#" className=" hover:underline text-black-500 dark:text-red-400 font-medium">Contact Us</a>
                </li>
            </ul>
        </div>
        <div>
            <h2 className="mb-6 text-sm font-semibold text-black-900 uppercase dark:text-red">Legal</h2>
            <ul className="text-black-500 dark:text-black-400 font-medium">
                <li className="mb-4">
                    <a href="#" className=" hover:underline text-black-500 dark:text-red-400 font-medium">Privacy Policy</a>
                </li>
                <li className="mb-4">
                    <a href="#" className=" hover:underline text-black-500 dark:text-red-400 font-medium">Licensing</a>
                </li>
                <li className="mb-4">
                    <a href="#" className=" hover:underline text-black-500 dark:text-red-400 font-medium">Terms &amp; Conditions</a>
                </li>
            </ul>
        </div>
        <div>
            <h2 className="mb-6 text-sm font-semibold text-black-900 uppercase dark:text-red">Download</h2>
            <ul className="text-black-500 dark:text-black-400 font-medium">
                <li className="mb-4">
                    <a href="#" className=" hover:underline text-black-500 dark:text-red-400 font-medium">iOS</a>
                </li>
                <li className="mb-4">
                    <a href="#" className=" hover:underline text-black-500 dark:text-red-400 font-medium">Android</a>
                </li>
                <li className="mb-4">
                    <a href="#" className=" hover:underline text-black-500 dark:text-red-400 font-medium">Windows</a>
                </li>
                <li className="mb-4">
                    <a href="#" className=" hover:underline text-black-500 dark:text-red-400 font-medium">MacOS</a>
                </li>
            </ul>
        </div>
    </div>
    <div className="px-4 py-6 bg-black-100 dark:bg-[#0c0d26] md:flex md:items-center md:justify-between">
        <span className="text-sm text-black-500 dark:text-black-300 sm:text-center">© 2023 <a href="https://flowbite.com/">Ultron™</a>. All Rights Reserved.
        </span>
        <div className="flex mt-4 space-x-6 sm:justify-center md:mt-0">
            <a href="#" className="text-black-400 hover:text-black-900 dark:hover:text-red">
