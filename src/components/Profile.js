...
export default function Profile () {
    ...
    if(!dataFetched)
        ...
        return (
            <div className="profileClass">
                <Navbar></Navbar>
                <div className="profileClass">
                <div className="flex text-center flex-col mt-11 md:text-2xl text-red ">
                    <div className="mb-5 mt-20">
                        <h2 className="font-bold"> Account ID : {address}</h2>  
                    </div>
                </div>
                <div className="flex flex-row text-center justify-center mt-10 md:text-2xl text-red ">
                        <div>
                            <h2 className="font-bold">Total Pokemons</h2>
                            {data.length}
                        </div>
                        <div className="ml-20">
                            <h2 className="font-bold">Total Pokemon Value</h2>
                            {totalPrice} MATIC
                        </div>
                </div>
                <div className="flex flex-col text-center items-center mt-11 text-red ">
                    <h2 className="font-bold">Your Pokemons</h2>
                    ...
                    <div className="mt-10 text-xl">
                        {data.length == 0 ? "Oops, No Player data to display (Are you logged in?)":""}
                    </div>
    ...
    <div className="mx-auto w-full max-w-screen-xl">
      <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
        <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-red">Company</h2>
        ...
        <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-red">Help center</h2>
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
        ...
        <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-red">Legal</h2>
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
        ...
        <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-red">Download</h2>
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
    ...
    <div className="px-4 py-6 bg-gray-100 dark:bg-[#0c0d26] md:flex md:items-center md:justify-between">
        ...
        <div className="flex mt-4 space-x-6 sm:justify-center md:mt-0">
            <a href="#" className="text-gray-400 hover:text-gray-900 dark:hover:text-red">
