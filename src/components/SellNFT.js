...
export default function SellNFT () {
    const [formParams, updateFormParams] = useState({ name: '', description: '', price: '',expiry: ''});
    ...
    async function uploadMetadataToIPFS() {
        const {name, description, price,expiry} = formParams;
    ...
    async function listNFT(e) {
        ...
        try {
            ...
            disableButton();
            updateMessage("Uploading (takes 5 mins).. please dont click anything!")
            ...
            enableButton();
            updateMessage("");
            updateFormParams({ name: '', description: '', price: '',expiry: '',});
